...
#### [NEW] [types.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/retrieval/types.py)
...
#### [NEW] [reranker.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/retrieval/reranker.py)
...
#### [NEW] [pdk_retriever.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/retrieval/pdk_retriever.py)
* Pipeline:
...
#### [NEW] [pdk_prompt.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/prompts/pdk_prompt.py)
* Move PDK-specific prompt definitions and guidelines out of expert code.

#### [MODIFY] [vector_store.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/vector_store.py)
* Expose similarity search helper supporting metadata filtering parameters.

#### [MODIFY] [experts/pdk_expert.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/experts/pdk_expert.py)
...
#### [NEW] [streaming.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/streaming.py)
...
#### [MODIFY] [main.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/main.py)
* Handle `stream=True` requests by returning a FastAPI `StreamingResponse`.

#### [MODIFY] [response_formatter.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/response_formatter.py)
...
#### [NEW] [eda_lint.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/tools/eda_lint.py)
* Create a lightweight validation tool checking Tcl syntax commands (bracket validation, restricted commands lists).

#### [NEW] [eda_retriever.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/retrieval/eda_retriever.py)
* Standard retrieval pipeline mapping to `EDA` manuals with tool filters.

#### [NEW] [eda_prompt.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/prompts/eda_prompt.py)
* Define prompt templates for:
  * Script generation (using manuals context)
  * Script refinement (using linter feedback)

#### [NEW] [eda_script_subgraph.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/experts/eda_script_subgraph.py)
...
#### [MODIFY] [experts/eda_script_expert.py](file:///Ubuntu/home/eason/proj/open-webui/chip_agent/src/experts/eda_script_expert.py)
...
- **M3**:
  - `PYTHONPATH=chip_agent chip_agent/.venv/bin/python3 -m pytest chip_agent/tests/test_pdk_retriever.py -v`
  - `PYTHONPATH=chip_agent chip_agent/.venv/bin/python3 -m pytest chip_agent/tests/test_pdk_expert.py -v`
- **M4**:
  - `PYTHONPATH=chip_agent chip_agent/.venv/bin/python3 -m pytest chip_agent/tests/test_streaming.py -v`
- **M5**:
  - `PYTHONPATH=chip_agent chip_agent/.venv/bin/python3 -m pytest chip_agent/tests/test_eda_subgraph.py -v`
- **Full Suite**:
  - `PYTHONPATH=chip_agent chip_agent/.venv/bin/python3 -m pytest -v`
