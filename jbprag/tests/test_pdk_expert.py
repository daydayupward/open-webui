...
@pytest.mark.anyio
async def test_pdk_expert_node(mock_retrieve, mock_get_llm, mock_grade_relevance, mock_grade_hallucination, mock_grade_completeness):
    # Mock LLM
    mock_llm = AsyncMock()
    ...
    # Mock Evaluators
    mock_grade_relevance.return_value = True
    mock_grade_hallucination.return_value = True
    mock_grade_completeness.return_value = True
