"""Tests for jbprag.src.ingestion.metadata_mapper."""
...
def pdk_chunks(pdk_doc):
    ...
    return chunk_document(pdk_doc, max_chunk_tokens=200)
...
class TestMapChunks:
    ...
    def test_fields_match_seed_data_pattern(self, project_doc):
        ...
        chunks = chunk_document(project_doc, max_chunk_tokens=500)
